...
get_ipython().system('pip install -q http://download.pytorch.org/whl/cu91/torch-0.4.0-cp36-cp36m-linux_x86_64.whl')
...
get_ipython().system('unzip "drive/My Drive/flower_data.zip"')
